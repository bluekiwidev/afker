...
1. Place pickaxes in your hotbar slots (1-9)
2. Position your mouse where you want to mine
3. Run the application
4. You have 10 seconds to switch back to your game window
5. The script will hold down the left mouse button and automatically switch to the next hotbar slot after each pickaxe breaks
